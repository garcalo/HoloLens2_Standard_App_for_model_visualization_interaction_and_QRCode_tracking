    ...
    internal class SpatialGraphNode
    {
        ...
        public bool TryLocate(out Pose pose)
        {
            ...
            if (relativePose != null)
            {
                ...
                Debug.Log("[SpatialGraphNode] Raw Matrix: " + newMatrix.ToString());
                ...
                Debug.Log("[SpatialGraphNode]Translation: " + translation.ToString());
                Debug.Log("[SpatialGraphNode]Rotation: " + rotation.ToString());
